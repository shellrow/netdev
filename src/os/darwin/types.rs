...
const IFRTYPE_FUNCTIONAL_WIFI: u32 = 3;
const IFRTYPE_FUNCTIONAL_CELLULAR: u32 = 4;
const IFRTYPE_FUNCTIONAL_INTCOPROC: u32 = 5;
const IFRTYPE_FUNCTIONAL_COMPANIONLINK: u32 = 6;
const IFRTYPE_FUNCTIONAL_MANAGEMENT: u32 = 7;

fn map_to_interface_type(ft: u32) -> crate::interface::types::InterfaceType {
    use crate::interface::types::InterfaceType;
    match ft {
        IFRTYPE_FUNCTIONAL_LOOPBACK => InterfaceType::Loopback,
        IFRTYPE_FUNCTIONAL_WIRED => InterfaceType::Ethernet,
        IFRTYPE_FUNCTIONAL_WIFI => InterfaceType::Wireless80211,
        IFRTYPE_FUNCTIONAL_CELLULAR => InterfaceType::Wwanpp,
        IFRTYPE_FUNCTIONAL_MANAGEMENT => InterfaceType::Unknown,
...
pub fn get_functional_type(name: &str) -> InterfaceType {
